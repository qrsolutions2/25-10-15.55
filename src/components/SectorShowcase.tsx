...
const sectors = [
  ...
  },
  {
    ...
    expandedImage: 'https://images.unsplash.com/photo-1729863430330-9815c9e15712?q=80&w=2970&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
  },
  {
    ...
    description: 'Enhance workplace safety and asset management with QR codes. Provide instant access to safety protocols, equipment manuals, maintenance records, and inspection checklists. Our QR solutions help organizations streamline operations by offering quick access to critical documentation, maintenance histories, and safety guidelines, improving efficiency and compliance.',
...
const SectorShowcase: React.FC<{ id: string }> = ({ id }) => {
  ...
  return (
    <section id={id} className="py-8 bg-black text-white relative">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-6">Choose your sector</h2>
